...
cp -f "${FRONTEND_SOURCE_DIR}/gemini_telegram_client_enhancement.js" .
...
cp -f "${FRONTEND_SOURCE_DIR}/user_form.js" .
...
git add index.html text_chat.html voice_chat.html styles.css gemini_telegram_client.js gemini_telegram_client_enhancement.js telegram_audio_bridge.js ui_controller.js advanced_audio_recorder.js audio_processor_worklet.js pcm_stream_player.js user_form.js assets
